 ...
 * 新手引导管理器 - 状态 - 格挡
 */
export default class GuideMgrStatusP1U11DefendAgain extends GuideMgrStatus {
    ...
    public OnEnter(): void {
        ...
        this.relMgr.guideTipsTxt = `格挡成功后直接刷新冷却，可再次格挡！`;
    ...
    public P1U8OnBtnDefendTouched(): void {
        ...
        jiang.mgrData.Set (indexDataStorageItem.guideStep, 1);
    }
    public P1U2OnGamePlayViewStyle () {
        ...
        this.relMgr.gamePlayView.btnForward.SetEnable (true);
