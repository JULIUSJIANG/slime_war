 ...
 * 新手引导 - 状态 - 等待攻击
 */
export default class GuideMgrStatusP1U3Atk extends GuideMgrStatus {
    /**
     * 时间缩放的应用 id
     */
    ...
    public OnEnter(): void {
        ...
        this.relMgr.guideTipsTxt = `点击场景以攻击史莱姆`;
    ...
    public P1U2OnBtnAimTouchStart (com: GamePlayView, pos: cc.Event.EventTouch) {
        ...
        // 进入下一个引导状态
        this.relMgr.EnterStatus (this.relMgr.statusP1U4Wait);
    }
