...
import Logic3020Args from "./Logic3020Args";
import Logic3020Status from "./Logic3020Status";
import Logic3020StatusCD from "./Logic3020StatusCD";
import Logic3020StatusOrdinary from "./Logic3020StatusOrdinary";
...
import Logic3020StatusPower from "./Logic3020StatusPower";
 ...
 * 经典模板，寻敌、跃击 + 受伤直接反击
 */
export default class Logic3020 extends GameElementBodyBehaviour {
    /**
     * 重力缩放
     */
     ...
     * 参数
     */
    public args: Logic3020Args;

    constructor () {
        super();
        this.statusOrdinary = Logic3020StatusOrdinary.Pop(APP, this);
        this.statusPower = Logic3020StatusPower.Pop(APP, this);
        this.statusCD = Logic3020StatusCD.Pop(APP, this);
    }
 
    private static _t = new UtilObjPoolType<Logic3020>({
        instantiate: () => {
            return new Logic3020();
        },
        onPop: (t) => {
    ...
    static Pop (apply: string, ge: GameElementBody, args: Logic3020Args) {
        let val = UtilObjPool.Pop(Logic3020._t, apply);
        val.relBody = ge;
        val.args = args;
     ...
     * 当前状态
     */
    public currStatus: Logic3020Status;

    /**
     * 状态 - 常态
     */
    public statusOrdinary: Logic3020StatusOrdinary;
    /**
     * 状态 - 蓄力
     */
    public statusPower: Logic3020StatusPower;
    /**
     * 状态 - 已受伤
     */
    public statusCD: Logic3020StatusCD;

    /**
     * 进入某个状态
     * @param status 
     */
    public EnterStatus (status: Logic3020Status) {
    ...
    public OnInit(): void {
        ...
        mainBodyDef.gravityScale = Logic3020.GRAVITY_SCALE;
    ...
    protected Logic3020OnDestory () {

    }

    static rs = GameElementBodyBehaviourRS.Pop<Logic3020Args>(
        APP,
        {
            logicCode: 3020,
            cfgToArgs: (cfg) => {
            ...
            init: (ge, t) => {
                ge.commonBehaviour = Logic3020.Pop(APP, ge, t);
            },
