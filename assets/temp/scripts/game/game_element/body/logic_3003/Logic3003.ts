...
import Logic3003Args from "./Logic3003Args";
import Logic3003Status from "./Logic3003Status";
import Logic3003StatusCD from "./Logic3003StatusCD";
import Logic3003StatusOrdinary from "./Logic3003StatusOrdinary";
...
import Logic3003StatusPower from "./Logic3003StatusPower";
import Logic3003StatusJumped from "./Logic3003StatusJumped";
import GameDisplayBody002 from "../../../display/GameDisplayBody002";
import GameElementLigthPoint from "../../common/GameElementLightPoint";
import Logic3003StatusMovePower from "./Logic3003StatusMovePower";
import Logic3003StatusMoveJump from "./Logic3003StatusMoveJump";
 ...
 * 经典模板，寻敌、跃击
 */
export default class Logic3003 extends GameElementBodyBehaviour {
    /**
     * 重力缩放
     */
     ...
     * 参数
     */
    public args: Logic3003Args;

    constructor () {
        super();
        this.statusOrdinary = Logic3003StatusOrdinary.Pop(APP, this);
        this.statusPower = Logic3003StatusPower.Pop(APP, this);
        this.statusJumped = Logic3003StatusJumped.Pop(APP, this);
        this.statusCD = Logic3003StatusCD.Pop(APP, this);
        this.statusMovePower = Logic3003StatusMovePower.Pop(APP, this);
        this.statusMoveJump = Logic3003StatusMoveJump.Pop(APP, this);
    }
 
    private static _t = new UtilObjPoolType<Logic3003>({
        instantiate: () => {
            return new Logic3003();
        },
        onPop: (t) => {
    ...
    static Pop (apply: string, ge: GameElementBody, args: Logic3003Args) {
        let val = UtilObjPool.Pop(Logic3003._t, apply);
        val.relBody = ge;
        val.args = args;
     ...
     * 当前状态
     */
    public currStatus: Logic3003Status;

    /**
     * 状态 - 常态
     */
    public statusOrdinary: Logic3003StatusOrdinary;
    /**
     * 状态 - 蓄力
     */
    public statusPower: Logic3003StatusPower;
    /**
     * 状态 - 跳跃
     */
    public statusJumped: Logic3003StatusJumped;
    /**
     * 状态 - 已受伤
     */
    public statusCD: Logic3003StatusCD;
    /**
     * 移动蓄力
     */
    public statusMovePower: Logic3003StatusMovePower;
    /**
     * 移动跳跃
     */
    public statusMoveJump: Logic3003StatusMoveJump;

    /**
     * 进入某个状态
     * @param status 
     */
    public EnterStatus (status: Logic3003Status) {
    ...
    public OnInit(): void {
        ...
        mainBodyDef.gravityScale = Logic3003.GRAVITY_SCALE;
    ...
    protected Logic3003OnDestory () {

    }

    static rs = GameElementBodyBehaviourRS.Pop<Logic3003Args>(
        APP,
        {
            logicCode: 3003,
            cfgToArgs: (cfg) => {
            ...
            init: (ge, t) => {
                ge.commonBehaviour = Logic3003.Pop(APP, ge, t);
            },
