...
import Logic3004Args from "./Logic3004Args";
import Logic3004Status from "./Logic3004Status";
import Logic3004StatusCD from "./Logic3004StatusCD";
import Logic3004StatusOrdinary from "./Logic3004StatusOrdinary";
...
import Logic3004StatusPower from "./Logic3004StatusPower";
 ...
 * 经典模板，寻敌、跃击 + 抛射弹药
 */
export default class Logic3004 extends GameElementBodyBehaviour {
    /**
     * 重力缩放
     */
     ...
     * 参数
     */
    public args: Logic3004Args;

    constructor () {
        super();
        this.statusOrdinary = Logic3004StatusOrdinary.Pop(APP, this);
        this.statusPower = Logic3004StatusPower.Pop(APP, this);
        this.statusCD = Logic3004StatusCD.Pop(APP, this);
    }
 
    private static _t = new UtilObjPoolType<Logic3004>({
        instantiate: () => {
            return new Logic3004();
        }, 
        onPop: (t) => {
    ...
    static Pop (apply: string, ge: GameElementBody, args: Logic3004Args) {
        let val = UtilObjPool.Pop(Logic3004._t, apply);
        val.relBody = ge;
        val.args = args;
     ...
     * 当前状态
     */
    public currStatus: Logic3004Status;

    /**
     * 状态 - 常态
     */
    public statusOrdinary: Logic3004StatusOrdinary;
    /**
     * 状态 - 蓄力
     */
    public statusPower: Logic3004StatusPower;
    /**
     * 状态 - 已受伤
     */
    public statusCD: Logic3004StatusCD;

    /**
     * 进入某个状态
     * @param status 
     */
    public EnterStatus (status: Logic3004Status) {
    ...
    public OnInit(): void {
        ...
        mainBodyDef.gravityScale = Logic3004.GRAVITY_SCALE;
    ...
    protected Logic3004OnDestory () {

    }

    static rs = GameElementBodyBehaviourRS.Pop<Logic3004Args>(
        APP,
        {
            logicCode: 3004,
            cfgToArgs: (cfg) => {
            ...
            init: (ge, t) => {
                ge.commonBehaviour = Logic3004.Pop(APP, ge, t);
            },
