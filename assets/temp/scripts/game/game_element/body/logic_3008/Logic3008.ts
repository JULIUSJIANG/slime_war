...
import Logic3008Args from "./Logic3008Args";
import Logic3008Status from "./Logic3008Status";
import Logic3008StatusCD from "./Logic3008StatusCD";
import Logic3008StatusOrdinary from "./Logic3008StatusOrdinary";
...
import Logic3008StatusPower from "./Logic3008StatusPower";
import Logic3008StatusJumped from "./Logic3008StatusJumped";
import GameElementLigthPoint from "../../common/GameElementLightPoint";
import GameDisplayBody006 from "../../../display/GameDisplayBody006";
 ...
 * 经典模板，寻敌、跃击 + 遁地
 */
export default class Logic3008 extends GameElementBodyBehaviour {
    /**
     * 重力缩放
     */
     ...
     * 参数
     */
    public args: Logic3008Args;

    constructor () {
        super();
        this.statusOrdinary = Logic3008StatusOrdinary.Pop(APP, this);
        this.statusPower = Logic3008StatusPower.Pop(APP, this);
        this.statusJumped = Logic3008StatusJumped.Pop(APP, this);
        this.statusCD = Logic3008StatusCD.Pop(APP, this);
    }
 
    private static _t = new UtilObjPoolType<Logic3008>({
        instantiate: () => {
            return new Logic3008();
        },
        onPop: (t) => {
    ...
    static Pop (apply: string, ge: GameElementBody, args: Logic3008Args) {
        let val = UtilObjPool.Pop(Logic3008._t, apply);
        val.relBody = ge;
        val.args = args;
     ...
     * 当前状态
     */
    public currStatus: Logic3008Status;

    /**
     * 状态 - 常态
     */
    public statusOrdinary: Logic3008StatusOrdinary;
    /**
     * 状态 - 蓄力
     */
    public statusPower: Logic3008StatusPower;
    /**
     * 状态 - 跳跃
     */
    public statusJumped: Logic3008StatusJumped;
    /**
     * 状态 - 已受伤
     */
    public statusCD: Logic3008StatusCD;

    /**
     * 进入某个状态
     * @param status 
     */
    public EnterStatus (status: Logic3008Status) {
    ...
    public OnInit(): void {
        ...
        mainBodyDef.gravityScale = Logic3008.GRAVITY_SCALE;
    ...
    protected Logic3008OnDestory () {

    }

    static rs = GameElementBodyBehaviourRS.Pop<Logic3008Args>(
        APP,
        {
            logicCode: 3008,
            cfgToArgs: (cfg) => {
            ...
            init: (ge, t) => {
                ge.commonBehaviour = Logic3008.Pop(APP, ge, t);
            },
            instDisplay: (state, ge, displayList) => {
                displayList.push(GameDisplayBody006.GetNodeType(ge.commonArgsCfg).CreateNode(
                    state,
                    ge.id,
                    ge.id
                ));
