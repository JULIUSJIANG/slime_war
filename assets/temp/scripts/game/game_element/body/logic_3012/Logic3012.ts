...
import Logic3012Args from "./Logic3012Args";
import Logic3012Status from "./Logic3012Status";
import Logic3012StatusCD from "./Logic3012StatusCD";
import Logic3012StatusOrdinary from "./Logic3012StatusOrdinary";
...
import Logic3012StatusPower from "./Logic3012StatusPower";
 ...
 * 经典模板，寻敌、跃击 + 随机抛射弹药
 */
export default class Logic3012 extends GameElementBodyBehaviour {
    /**
     * 重力缩放
     */
     ...
     * 参数
     */
    public args: Logic3012Args;

    constructor () {
        super();
        this.statusOrdinary = Logic3012StatusOrdinary.Pop(APP, this);
        this.statusPower = Logic3012StatusPower.Pop(APP, this);
        this.statusCD = Logic3012StatusCD.Pop(APP, this);
    }
 
    private static _t = new UtilObjPoolType<Logic3012>({
        instantiate: () => {
            return new Logic3012();
        },
        onPop: (t) => {
    ...
    static Pop (apply: string, ge: GameElementBody, args: Logic3012Args) {
        let val = UtilObjPool.Pop(Logic3012._t, apply);
        val.relBody = ge;
        val.args = args;
     ...
     * 当前状态
     */
    public currStatus: Logic3012Status;

    /**
     * 状态 - 常态
     */
    public statusOrdinary: Logic3012StatusOrdinary;
    /**
     * 状态 - 蓄力
     */
    public statusPower: Logic3012StatusPower;
    /**
     * 状态 - 已受伤
     */
    public statusCD: Logic3012StatusCD;

    /**
     * 进入某个状态
     * @param status 
     */
    public EnterStatus (status: Logic3012Status) {
    ...
    public OnInit(): void {
        ...
        mainBodyDef.gravityScale = Logic3012.GRAVITY_SCALE;
    ...
    protected Logic3012OnDestory () {

    }

    static rs = GameElementBodyBehaviourRS.Pop<Logic3012Args>(
        APP,
        {
            logicCode: 3012,
            cfgToArgs: (cfg) => {
                return {
                    ...
                    count: Number.parseFloat(cfg.prop_11),
                    random: Number.parseFloat(cfg.prop_12)
                };
            },
            init: (ge, t) => {
                ge.commonBehaviour = Logic3012.Pop(APP, ge, t);
            },
