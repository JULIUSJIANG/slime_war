...
import Logic3034Args from "./Logic3034Args";
import Logic3034Status from "./Logic3034Status";
import Logic3034StatusCD from "./Logic3034StatusCD";
import Logic3034StatusOrdinary from "./Logic3034StatusOrdinary";
...
import Logic3034StatusPower from "./Logic3034StatusPower";
...
/**
 * 经典模板，寻敌、跃击 + 抛射弹药 + 橡果适配
 */
export default class Logic3034 extends GameElementBodyBehaviour {
    /**
     * 重力缩放
     */
     ...
     * 参数
     */
    public args: Logic3034Args;

    constructor () {
        super();
        this.statusOrdinary = Logic3034StatusOrdinary.Pop(APP, this);
        this.statusPower = Logic3034StatusPower.Pop(APP, this);
        this.statusCD = Logic3034StatusCD.Pop(APP, this);
    }
 
    private static _t = new UtilObjPoolType<Logic3034>({
        instantiate: () => {
            return new Logic3034();
        }, 
        onPop: (t) => {
    ...
    static Pop (apply: string, ge: GameElementBody, args: Logic3034Args) {
        let val = UtilObjPool.Pop(Logic3034._t, apply);
        val.relBody = ge;
        val.args = args;
     ...
     * 当前状态
     */
    public currStatus: Logic3034Status;

    /**
     * 状态 - 常态
     */
    public statusOrdinary: Logic3034StatusOrdinary;
    /**
     * 状态 - 蓄力
     */
    public statusPower: Logic3034StatusPower;
    /**
     * 状态 - 已受伤
     */
    public statusCD: Logic3034StatusCD;

    /**
     * 进入某个状态
     * @param status 
     */
    public EnterStatus (status: Logic3034Status) {
    ...
    public OnInit(): void {
        ...
        mainBodyDef.gravityScale = Logic3034.GRAVITY_SCALE;
    ...
    protected Logic3034OnDestory () {

    }

    static rs = GameElementBodyBehaviourRS.Pop<Logic3034Args>(
        APP,
        {
            logicCode: 3034,
            cfgToArgs: (cfg) => {
                return {
                    ...
                    bullet: utilString.ParseStrToListNum(cfg.prop_10),
                    bulletColor: utilString.ParseStrToCCColor(cfg.prop_11)
                };
            },
            init: (ge, t) => {
                ge.commonBehaviour = Logic3034.Pop(APP, ge, t);
            },
