...
import Logic3032Args from "./Logic3032Args";
 ...
 * 箭头
 */
class Logic3032 extends GameElementBodyBehaviour {
    /**
     * 参数
     */
    public args: Logic3032Args;
    ...
    private static _t = new UtilObjPoolType<Logic3032>({
        instantiate: () => {
            return new Logic3032();
        },
        onPop: (t) => {
    ...
    static Pop (apply: string, ge: GameElementBody, args: Logic3032Args) {
        let val = UtilObjPool.Pop(Logic3032._t, apply);
        val.relBody = ge;
        val.args = args;
        return val;
    }
...
namespace Logic3032 {
    export const rs = GameElementBodyBehaviourRS.Pop<Logic3032Args>(
        APP,
        {
            logicCode: 3032,
            cfgToArgs: (cfg) => {
            ...
            init: (ge, t) => {
                ge.commonBehaviour = Logic3032.Pop(APP, ge, t);
            },
