...
import Logic3021Args from "./Logic3021Args";
import Logic3021Status from "./Logic3021Status";
import Logic3021StatusCD from "./Logic3021StatusCD";
import Logic3021StatusOrdinary from "./Logic3021StatusOrdinary";
...
import Logic3021StatusPower from "./Logic3021StatusPower";
 ...
 * 经典模板，寻敌、跃击 + 召唤友军
 */
export default class Logic3021 extends GameElementBodyBehaviour {
    /**
     * 重力缩放
     */
     ...
     * 参数
     */
    public args: Logic3021Args;

    constructor () {
        super();
        this.statusOrdinary = Logic3021StatusOrdinary.Pop(APP, this);
        this.statusPower = Logic3021StatusPower.Pop(APP, this);
        this.statusCD = Logic3021StatusCD.Pop(APP, this);
    }
 
    private static _t = new UtilObjPoolType<Logic3021>({
        instantiate: () => {
            return new Logic3021();
        },
        onPop: (t) => {
    ...
    static Pop (apply: string, ge: GameElementBody, args: Logic3021Args) {
        let val = UtilObjPool.Pop(Logic3021._t, apply);
        val.relBody = ge;
        val.args = args;
     ...
     * 当前状态
     */
    public currStatus: Logic3021Status;

    /**
     * 状态 - 常态
     */
    public statusOrdinary: Logic3021StatusOrdinary;
    /**
     * 状态 - 蓄力
     */
    public statusPower: Logic3021StatusPower;
    /**
     * 状态 - 已受伤
     */
    public statusCD: Logic3021StatusCD;

    /**
     * 进入某个状态
     * @param status 
     */
    public EnterStatus (status: Logic3021Status) {
    ...
    public OnInit(): void {
        ...
        mainBodyDef.gravityScale = Logic3021.GRAVITY_SCALE;
    ...
    protected Logic3021OnDestory () {

    }

    static rs = GameElementBodyBehaviourRS.Pop<Logic3021Args>(
        APP,
        {
            logicCode: 3021,
            cfgToArgs: (cfg) => {
                return {
                    ...
                    listCallTarget: utilString.ParseStrToListNum (cfg.prop_10),
                    areaCall: Number.parseFloat (cfg.prop_11),
                    maxCount: Number.parseFloat (cfg.prop_12)
                };
            },
            init: (ge, t) => {
                ge.commonBehaviour = Logic3021.Pop(APP, ge, t);
            },
