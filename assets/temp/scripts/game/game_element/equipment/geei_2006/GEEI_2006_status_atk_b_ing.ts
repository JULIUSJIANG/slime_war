...
const APP = `GEEI_2006_status_b_ing`;

/**
 * 开火中
 */
export default class GEEI_2006_status_b_ing extends GEEI_2006_status {

    private constructor () {
        super ();
    }

    private static _t = new UtilObjPoolType<GEEI_2006_status_b_ing>({
        instantiate: () => {
            return new GEEI_2006_status_b_ing ();
        },
        onPop: (t) => {
    ...
    static Pop (apply: string, rel: GEEI_2006) {
        let val = UtilObjPool.Pop (GEEI_2006_status_b_ing._t, apply);
        val.rel = rel;
        return val;
    }
